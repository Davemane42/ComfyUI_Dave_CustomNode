...
function addCanvas(node, app) {
	...
	const widget = {
		...
		draw: function (ctx, node, widgetWidth, widgetY) {
			...
			//ctx.fillRect(xOffset, yOffset, backgroudSize, backgroudSize);
			...
			for (const [k, v] of values.entries()) {
				...
				let x = widgetX + v[0]*backgroudWidth/width
				let y = widgetY + v[1]*backgroudWidth/width
				let w = v[2]*backgroundHeight/height
